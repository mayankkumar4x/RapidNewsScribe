...
export default function Notes(props) {
  ...
  return (
    <>
      ...
      <div className='w-100 d-flex flex-row-reverse'>      
        <AddNote showAlert={props.showAlert} newsUrl={props.newsUrl}/>
  ...
  <h2 className="text-center mb-4 fw-bold text-primary heading-glow">📝 Your Notes</h2>
    ...
    {notes.length ? (
      ...
      <div className="text-center w-100">
        <p className="fs-5 text-muted">
          <i className="bi bi-emoji-frown"></i> No notes to display
        </p>
      </div>
    )}
  </div>
