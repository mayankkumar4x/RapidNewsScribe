...
const AddNote = (props) => {
  ...
  const [note, setNote] = useState({ title: "", description: "", newsUrl: props.newsUrl, tag: "" });
  const handleClick = (e) => {
    e.preventDefault();
    ...
    <div className='container col-3 bg-dark text-light p-3'>
      ...
      <form onSubmit={handleClick}>
        ...
        <div className="form-group">
          ...
          <input type="text" className="form-control" id="newsURL" name="newsUrl" placeholder="No URL" value={note.newsUrl} disabled />
        </div>
        <div className="form-group">
